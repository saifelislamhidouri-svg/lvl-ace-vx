...
async def SevenmInV (uid ,K ,V ):
    ...
    1 :33 ,
    2 :{
    1 :int (uid ),2 :"ME",3 :1 ,4 :1 ,6 :"xXcT",7 :330 ,8 :1000 ,9 :100 ,
    10 :"@xCTx_AyOuB",12 :1 ,13 :int (uid ),16 :1 ,
...
async def xSEndMsg (Msg ,Tp ,Tp2 ,id ,K ,V ):
    ...
    9 :{1 :"XcT-xAyOuB",2 :int (await xBunnEr ()),3 :901048020 ,4 :330 ,5 :909000014 ,8 :"XcT-xAyOuB",10 :1 ,11 :1 ,13 :{1 :2 },14 :{1 :12484827014 ,2 :8 ,3 :"\u0010\u0015\b\n\u000b\u0013\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"},12 :0 },
    10 :"en",13 :{3 :1 }}
    Pk =(await CrEaTe_ProTo (fields )).hex ()
    Pk ="080112"+await EnC_Uid (len (Pk )//2 ,Tp ='Uid')+Pk 
